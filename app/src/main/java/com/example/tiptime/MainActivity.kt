...
fun TipTimeLayout() {
    ...
    val tipping = tipInput.toDoubleOrNull() ?: 0.0
    val tip = calculateTip(amount,tipping)
    Column(
        modifier = Modifier
            .statusBarsPadding()
        ...
        EditPercentageField(value = tipInput,
...
//private fun roundUpTip(tipPercent: Double ): String {
//    val roundUp = ceil(tipPercent)
//    return NumberFormat.getCurrencyInstance().format(roundUp)
//}
